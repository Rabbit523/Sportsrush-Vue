    ...
    <div class="messageWrapper">
        <div id="msgs" class="Messages" is="sui-container">           
                <div class="Message" is="sui-container" fluid v-for="msg in messagesLocal" v-bind:key="msg.idMessage" v-if="!msg.hidden">
                    ...
                    <sui-comment-group v-bind:key="msg.idMessage">
                        <sui-comment>
...
<!--                                <sui-comment-actions>
                    ...
                    <!--                <sui-grid :columns="2">
                        <sui-grid-row>
                            <sui-grid-column class="avatar" :width="2">
                                <img src="../assets/bandmember.jpg" alt="Avatar">
                            </sui-grid-column>
                            <sui-grid-column class="MainContent" :width="14">
                                <p>{{msg.sender}}: {{msg.message}}</p>
                                <span class="time-right">{{msg.sendingDateTime}}</span>
                            </sui-grid-column>               
                        </sui-grid-row>
                    </sui-grid>-->
                </div> 
                ...
                methods: {
                    ...
                    addMessage() {
                        ...
                        if (this.newMessage !== "") {
                            ...
                            this.newMessage = '';
                            this.$store.dispatch('createMsg', message);
